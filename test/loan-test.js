...
describe('************ Loans ******************', ()  => {
  ...
  before(async () => {
    ...
    const tx1 = await nft.connect(borrower).createToken('https://fake-uri-1.com', 1, borrowerAddress, royaltyValue, false);
    const receipt1 = await tx1.wait();
		token1Id = receipt1.events[0].args[2].toNumber();

    const tx2 = await nft.connect(borrower).createToken('https://fake-uri-2.com', 1, borrowerAddress, royaltyValue, false);
